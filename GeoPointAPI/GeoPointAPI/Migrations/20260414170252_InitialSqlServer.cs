        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    work_days = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    work_schedule_id = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entity_affected = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    balance_minutes = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    justification_user = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    justification_reviewer = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    latitude_recorded = table.Column<decimal>(type: "decimal(10,8)", precision: 10, scale: 8, nullable: false),
                    longitude_recorded = table.Column<decimal>(type: "decimal(11,8)", precision: 11, scale: 8, nullable: false),
                    is_manual_adjustment = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    google_drive_file_id = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Comercial", new TimeSpan(0, 18, 0, 0, 0), "Comercial (08h-18h)", new TimeSpan(0, 8, 0, 0, 0), 10, "1,2,3,4,5" },
                    { "Contractor", new TimeSpan(0, 18, 0, 0, 0), "Contractor (09h-18h)", new TimeSpan(0, 9, 0, 0, 0), 5, "1,2,3,4,5" },
                    { "Intern", new TimeSpan(0, 15, 0, 0, 0), "Intern (08h-15h)", new TimeSpan(0, 8, 0, 0, 0), 15, "1,2,3,4,5" }
                });
